<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="管理工号" prop="guanligonghao">
          <el-select  @change="guanligonghaoChange" v-model="ruleForm.guanligonghao" placeholder="请选择管理工号">
            <el-option
                v-for="(item,index) in guanligonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.guanligonghao" label="管理工号" prop="guanligonghao">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.yuangongxingming!=''&&json.yuangongxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yuangongguanli/guanligonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.guanligonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    guanligonghaoChange () {
      this.$http({
        url: `follow/yuangongguanli/guanligonghao?columnValue=`+ this.ruleForm.guanligonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
