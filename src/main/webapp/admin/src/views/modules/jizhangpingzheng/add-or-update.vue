<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="凭证编号" prop="pingzhengbianhao">
          <el-input v-model="ruleForm.pingzhengbianhao" 
              placeholder="凭证编号" clearable  :readonly="ro.pingzhengbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="凭证编号" prop="pingzhengbianhao">
              <el-input v-model="ruleForm.pingzhengbianhao" 
                placeholder="凭证编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="凭证名称" prop="pingzhengmingcheng">
          <el-input v-model="ruleForm.pingzhengmingcheng" 
              placeholder="凭证名称" clearable  :readonly="ro.pingzhengmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="凭证名称" prop="pingzhengmingcheng">
              <el-input v-model="ruleForm.pingzhengmingcheng" 
                placeholder="凭证名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="凭证内容" prop="pingzhengneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="凭证内容"
                  v-model="ruleForm.pingzhengneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pingzhengneirong" label="凭证内容" prop="pingzhengneirong">
                    <span>{{ruleForm.pingzhengneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	pingzhengbianhao : false,
	pingzhengmingcheng : false,
	leixing : false,
	pingzhengneirong : false,
	dengjiriqi : false,
	fujian : false,
	beizhu : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='pingzhengbianhao'){
            this.ruleForm.pingzhengbianhao = obj[o];
	    this.ro.pingzhengbianhao = true;
            continue;
          }
          if(o=='pingzhengmingcheng'){
            this.ruleForm.pingzhengmingcheng = obj[o];
	    this.ro.pingzhengmingcheng = true;
            continue;
          }
          if(o=='leixing'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='pingzhengneirong'){
            this.ruleForm.pingzhengneirong = obj[o];
	    this.ro.pingzhengneirong = true;
            continue;
          }
          if(o=='dengjiriqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.leixingOptions = "专用记账凭证,通用记账凭证".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `jizhangpingzheng/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jizhangpingzheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jizhangpingzhengCrossAddOrUpdateFlag = false;
                  this.parent.search();
