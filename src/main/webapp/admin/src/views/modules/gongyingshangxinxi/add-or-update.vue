<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应商姓名" prop="gongyingshangxingming">
          <el-input v-model="ruleForm.gongyingshangxingming" 
              placeholder="供应商姓名" clearable  :readonly="ro.gongyingshangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应商姓名" prop="gongyingshangxingming">
              <el-input v-model="ruleForm.gongyingshangxingming" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应产品" prop="gongyingchanpin">
          <el-input v-model="ruleForm.gongyingchanpin" 
              placeholder="供应产品" clearable  :readonly="ro.gongyingchanpin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应产品" prop="gongyingchanpin">
              <el-input v-model="ruleForm.gongyingchanpin" 
                placeholder="供应产品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合作时长" prop="hezuoshizhang">
          <el-input v-model="ruleForm.hezuoshizhang" 
              placeholder="合作时长" clearable  :readonly="ro.hezuoshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合作时长" prop="hezuoshizhang">
              <el-input v-model="ruleForm.hezuoshizhang" 
                placeholder="合作时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongyingshangxingming = true;
            continue;
          }
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='hezuoshizhang'){
            this.ruleForm.hezuoshizhang = obj[o];
	    this.ro.hezuoshizhang = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    info(id) {
      this.$http({
        url: `gongyingshangxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongyingshangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongyingshangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
