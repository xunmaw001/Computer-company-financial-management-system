<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="支票号" prop="zhipiaohao">
          <el-input v-model="ruleForm.zhipiaohao" 
              placeholder="支票号" clearable  :readonly="ro.zhipiaohao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="支票号" prop="zhipiaohao">
              <el-input v-model="ruleForm.zhipiaohao" 
                placeholder="支票号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收款单位" prop="shoukuandanwei">
          <el-input v-model="ruleForm.shoukuandanwei" 
              placeholder="收款单位" clearable  :readonly="ro.shoukuandanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收款单位" prop="shoukuandanwei">
              <el-input v-model="ruleForm.shoukuandanwei" 
                placeholder="收款单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhipiaohao'){
            this.ruleForm.zhipiaohao = obj[o];
	    this.ro.zhipiaohao = true;
            continue;
          }
          if(o=='shoukuandanwei'){
            this.ruleForm.shoukuandanwei = obj[o];
	    this.ro.shoukuandanwei = true;
            continue;
          }
          if(o=='jine'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhipiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhipiaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
