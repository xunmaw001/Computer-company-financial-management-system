<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发票编号" prop="fapiaobianhao">
          <el-input v-model="ruleForm.fapiaobianhao" 
              placeholder="发票编号" clearable  :readonly="ro.fapiaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发票编号" prop="fapiaobianhao">
              <el-input v-model="ruleForm.fapiaobianhao" 
                placeholder="发票编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品单价" prop="shangpindanjia">
          <el-input v-model="ruleForm.shangpindanjia" 
              placeholder="商品单价" clearable  :readonly="ro.shangpindanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品单价" prop="shangpindanjia">
              <el-input v-model="ruleForm.shangpindanjia" 
                placeholder="商品单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.shangpindanjia*this.ruleForm.shangpinshuliang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fapiaobianhao'){
            this.ruleForm.fapiaobianhao = obj[o];
	    this.ro.fapiaobianhao = true;
            continue;
          }
          if(o=='kehuxingming'){
	    ...
	    this.ro.shangpinmingcheng = true;
          ...
          if(o=='shangpindanjia'){
            this.ruleForm.shangpindanjia = obj[o];
	    this.ro.shangpindanjia = true;
            continue;
          }
