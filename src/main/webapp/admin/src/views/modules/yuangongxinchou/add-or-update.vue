<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="全勤奖励" prop="quanqinjiangli">
          <el-input v-model="ruleForm.quanqinjiangli" 
              placeholder="全勤奖励" clearable  :readonly="ro.quanqinjiangli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="全勤奖励" prop="quanqinjiangli">
              <el-input v-model="ruleForm.quanqinjiangli" 
                placeholder="全勤奖励" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="绩效奖励" prop="jixiaojiangli">
          <el-input v-model="ruleForm.jixiaojiangli" 
              placeholder="绩效奖励" clearable  :readonly="ro.jixiaojiangli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="绩效奖励" prop="jixiaojiangli">
              <el-input v-model="ruleForm.jixiaojiangli" 
                placeholder="绩效奖励" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社保补助" prop="shebaobuzhu">
          <el-input v-model="ruleForm.shebaobuzhu" 
              placeholder="社保补助" clearable  :readonly="ro.shebaobuzhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社保补助" prop="shebaobuzhu">
              <el-input v-model="ruleForm.shebaobuzhu" 
                placeholder="社保补助" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣款金额" prop="koukuanjine">
          <el-input v-model="ruleForm.koukuanjine" 
              placeholder="扣款金额" clearable  :readonly="ro.koukuanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣款金额" prop="koukuanjine">
              <el-input v-model="ruleForm.koukuanjine" 
                placeholder="扣款金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理工号" prop="guanligonghao">
          <el-input v-model="ruleForm.guanligonghao" 
              placeholder="管理工号" clearable  :readonly="ro.guanligonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理工号" prop="guanligonghao">
              <el-input v-model="ruleForm.guanligonghao" 
                placeholder="管理工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="扣款事项" prop="koukuanshixiang">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.koukuanshixiang" label="扣款事项" prop="koukuanshixiang">
                    <span>{{ruleForm.koukuanshixiang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
    shifagongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.quanqinjiangli==""?0:this.ruleForm.quanqinjiangli)+parseFloat(this.ruleForm.jixiaojiangli==""?0:this.ruleForm.jixiaojiangli)+parseFloat(this.ruleForm.shebaobuzhu==""?0:this.ruleForm.shebaobuzhu)-parseFloat(this.ruleForm.koukuanjine==""?0:this.ruleForm.koukuanjine) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jixiaojiangli = true;
          ...
          if(o=='shebaobuzhu'){
            this.ruleForm.shebaobuzhu = obj[o];
	    this.ro.shebaobuzhu = true;
            continue;
          }
          if(o=='koukuanjine'){
	    ...
	    this.ro.riqi = true;
          ...
          if(o=='guanligonghao'){
            this.ruleForm.guanligonghao = obj[o];
	    this.ro.guanligonghao = true;
            continue;
          }
          if(o=='guanlixingming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.guanligonghao!=''&&json.guanligonghao){
              		this.ruleForm.guanligonghao = json.guanligonghao
		}
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yuangongxinchou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongxinchouCrossAddOrUpdateFlag = false;
                  this.parent.search();
