<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴款金额" prop="jiaokuanjine">
          <el-input v-model="ruleForm.jiaokuanjine" 
              placeholder="缴款金额" clearable  :readonly="ro.jiaokuanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴款金额" prop="jiaokuanjine">
              <el-input v-model="ruleForm.jiaokuanjine" 
                placeholder="缴款金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="缴款日期" prop="jiaokuanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiaokuanriqi" 
                type="date"
                placeholder="缴款日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaokuanriqi" label="缴款日期" prop="jiaokuanriqi">
              <el-input v-model="ruleForm.jiaokuanriqi" 
                placeholder="缴款日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaofeimingcheng = true;
          ...
          if(o=='jiaokuanjine'){
            this.ruleForm.jiaokuanjine = obj[o];
	    this.ro.jiaokuanjine = true;
            continue;
          }
          if(o=='jiaokuanriqi'){
            this.ruleForm.jiaokuanriqi = obj[o];
	    this.ro.jiaokuanriqi = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yuangongjiaokuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongjiaokuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
