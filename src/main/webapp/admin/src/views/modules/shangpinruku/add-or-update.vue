<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否完好" prop="shifouwanhao">
          <el-select v-model="ruleForm.shifouwanhao" placeholder="请选择是否完好">
            <el-option
                v-for="(item,index) in shifouwanhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否完好" prop="shifouwanhao">
	      <el-input v-model="ruleForm.shifouwanhao"
                placeholder="是否完好" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.rukushijian = true;
          ...
          if(o=='shifouwanhao'){
            this.ruleForm.shifouwanhao = obj[o];
	    this.ro.shifouwanhao = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
		...
		if(json.yuangongxingming!=''&&json.yuangongxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.shifouwanhaoOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
