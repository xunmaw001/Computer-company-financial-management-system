<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合作项目" prop="hezuoxiangmu">
          <el-input v-model="ruleForm.hezuoxiangmu" 
              placeholder="合作项目" clearable  :readonly="ro.hezuoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合作项目" prop="hezuoxiangmu">
              <el-input v-model="ruleForm.hezuoxiangmu" 
                placeholder="合作项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsidizhi = true;
          ...
          if(o=='hezuoxiangmu'){
            this.ruleForm.hezuoxiangmu = obj[o];
	    this.ro.hezuoxiangmu = true;
            continue;
          }
          if(o=='hezuoshizhang'){
